		...
		<div className="flex max-h-80 w-full justify-between space-x-10 px-3 md:px-20">
			<PieChart
				...
				<PieChart
					...
					lineWidth="10"
					animate={true}>
					<text dominantBaseline="central" x="50" y="50" dy="-10" textAnchor="middle" className="fill-good text-xl">
						{props.teamstats.GOOD}
					</text>
					<text dominantBaseline="central" x="50" y="50" dy="10" textAnchor="middle" className=" fill-good/75 text-xs font-light">
						GOOD
					</text>
				</PieChart>
			</PieChart>
			<PieChart
				...
				<PieChart
					...
					lineWidth="10"
					animate={true}>
					<text dominantBaseline="central" x="50" y="50" dy="-10" textAnchor="middle" className="fill-warning text-xl">
						{props.teamstats.WARNING}
					</text>
					<text dominantBaseline="central" x="50" y="50" dy="10" textAnchor="middle" className=" fill-warning/50 text-xs font-light">
						WARNING
					</text>
				</PieChart>
			</PieChart>
			<PieChart
				...
				<PieChart
					...
					lineWidth="10"
					animate={true}>
					<text dominantBaseline="central" x="50" y="50" dy="-10" textAnchor="middle" className="fill-failure text-xl">
						{props.teamstats.FAILURE}
					</text>
					<text dominantBaseline="central" x="50" y="50" dy="10" textAnchor="middle" className=" fill-failure/75 text-xs font-light">
						FAIL
					</text>
				</PieChart>
			</PieChart>
